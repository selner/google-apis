...
class GoogleAPIBase:
    ...
    @staticmethod
    def _getTokenFromCreds(credentials):
...
class GABase(GoogleAPIBase):
    ...
    def __init__(self, emailAPIClient=None, pathAPISecretKey=None):
        GoogleAPIBase.__init__(self, 'analytics', 'v3', 'https://www.googleapis.com/auth/analytics.readonly',
                               emailAPIClient, pathAPISecretKey)
